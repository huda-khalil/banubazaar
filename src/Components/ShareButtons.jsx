...
export default function ShareButtons({ title, url }) {
  ...
  const shareText = encodeURIComponent(
    `Check out this item on BanuBazaar: ${title}`,
  );
    ...
    <div className="mt-4 pt-4 border-t border-gray-100">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#0088cc] text-white text-xs font-medium rounded-lg hover:opacity-80 transition"
        >
          <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#1877f2] text-white text-xs font-medium rounded-lg hover:opacity-80 transition"
        >
          <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
